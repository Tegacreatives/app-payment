...
// expo live link: https://expo.dev/@tegacreatives/payment-app
      ...
      <View style={{ paddingTop: 50, paddingHorizontal: 14 }}>
        <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
          <View>
            ...
            <Text style={{fontSize: 20, color: '#fff', opacity: 0.6}}>Runo Okorare</Text>
          </View>
          <View>
            <Image source={{
              uri:
              'https://images.pexels.com/photos/1722198/pexels-photo-1722198.jpeg?cs=srgb&dl=pexels-thyrone-paas-1722198.jpg&fm=jpg'
            }}
